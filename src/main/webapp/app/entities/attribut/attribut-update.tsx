...
import { getEntity, updateEntity, createEntity, reset } from './attribut.reducer';
import { IAttribut } from 'app/shared/model/attribut.model';
// tslint:disable-next-line:no-unused-variable
import { convertDateTimeFromServer } from 'app/shared/util/date-utils';
import { keysToValues } from 'app/shared/util/entity-utils';

export interface IAttributUpdateProps extends StateProps, DispatchProps, RouteComponentProps<{ id: number }> {}
...
export class AttributUpdate extends React.Component<IAttributUpdateProps, IAttributUpdateState> {
  ...
  render() {
    ...
    const { attributEntity, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="rctSampleApplicationApp.attribut.home.createOrEditLabel">
              <Translate contentKey="rctSampleApplicationApp.attribut.home.createOrEditLabel">Create or edit a Attribut</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
...
export default connect(mapStateToProps, mapDispatchToProps)(AttributUpdate);
